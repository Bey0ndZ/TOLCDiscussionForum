...
<body id="page-top" data-spy="scroll" oncontextmenu="return false" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <i class="fa fa-play-circle"></i>  <span class="light">Technologies for Online Learning Communities</span>
                </a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">Team Lexus</h1>
                        <p class="intro-text">TOLC Discussion Forum</p>
                ...
                <h2>Login</h2>
             	  <c:if test="${not empty error}">
					...
					<form name='loginForm' class="form-signin" role="form"
				        ...
				        <div class="checkbox">
				          <label>
				            New member? Click <a href="register">here</a>
				          </label>
				        </div>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; Team Lexus 2014</p>
        </div>
    </footer>
